...
plt.savefig('KNN_Validation_Confusion_Matrix_Medium.png',pdi=600)
...
fig.savefig('KNN_Validation_ROC_Medium.png',pdi=600)
...
plt.subplots_adjust(top=0.9, bottom=0.1, left=0.125, right=0.9, hspace=0.7 ,wspace=0.5)
plt.savefig('KNN_Test_Confusion_Matrix_Medium.png',pdi=600)
...
fig.subplots_adjust(top=0.9, bottom=0.1, left=0.125, right=0.9, hspace=0.7 ,wspace=0.5)
fig.savefig('KNN_Test_ROC_Medium.png',pdi=600)
